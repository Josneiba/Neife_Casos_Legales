    ...
    <div className="min-h-screen bg-[#F8F7F4] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="bg-white border border-[#D5C3B6]/30 rounded-lg shadow-sm p-8">
          ...
          <h1 className="text-2xl font-bold text-[#2D3C3C] text-center mb-6">
            Iniciar Sesión
          </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              />
              {errors.email && (
                <p className="mt-1 text-sm text-[#C27F79]">{errors.email}</p>
              )}
            </div>

            {/* Password */}
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-[#2D3C3C] mb-1">
                Contraseña
              </label>
              ...
              {errors.password && (
                <p className="mt-1 text-sm text-[#C27F79]">{errors.password}</p>
              )}
            </div>
          ...
          <div className="relative my-6">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-[#D5C3B6]"></div>
            </div>
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-[#75524C]">o continuar con</span>
            </div>
          </div>

          {/* Google Button */}
          <button className="w-full py-3 border border-[#D5C3B6] rounded-lg font-medium text-[#2D3C3C] hover:bg-[#F8F7F4] transition-colors flex items-center justify-center gap-2">
          ...
          <p className="mt-6 text-center text-[#75524C]">
            ¿No tienes cuenta?{" "}
            <Link href="/register" className="text-[#5E8B8C] font-semibold hover:underline">
              Registrarse
            </Link>
          </p>
        </div>
